...
hero:
  ...
  tertiaryCta:
    ...
    href: "https://github.com/Open-BeatBox"
sections:
  - type: "text"
    title: "Context & Scientific Background"
    body: "*Open-BEATBox is an autonomous home-cage behavioral system that lets rodents live inside the experimental apparatus while continuously performing tasks.*

By removing repeated handling, artificial session boundaries, and experimenter-driven timing, Open-BEATBox preserves circadian rhythms, motivation, and long-term behavioral dynamics. The result is richer, more ecological data with higher reproducibility and lower animal stress."
  - type: "list"
    title: "Open-BEATBox enables to:"
    items:
  ...
  - type: "mediaSplit"
    ...
    body: "Open-BEATBox is an open, modular platform for continuous behavioral monitoring in a home-cage-like environment. Tasks, sensors, and reward modules can be configured to match experimental goals while minimizing handling and stress."
    bullets:
  ...
  - type: "list"
    ...
    items:
      ...
      - "Peer-reviewed methods or preprints using Open-BEATBox (add link)."
  - type: "steps"
    title: "How to build Open-BEATBox"
    steps:
  ...
  - type: "columns"
    ...
    columns:
      - heading: "Open by design"
        body: |
          Open-BEATBox hardware and software are fully open-source, enabling inspection, adaptation, and replication across labs.
  ...
  - type: "links"
    ...
    links:
      ...
      - label: "Build guides"
        href: "https://github.com/Open-BeatBox/Open-BeatBox_Documentation"
      - label: "Documentation"
        href: "https://github.com/Open-BeatBox/Open-BeatBox_Documentation"
  ...
  - type: "text"
    title: "NERB team"
    body: "Open-BEATBox is developed by the NERB team: Eric Burguiere, Lizbeth Mondragon. Learn more at [nerb.team](https://nerb.team/)."
---
This one-pager summarizes Open-BEATBox and provides direct access to the open-source resources needed to build and extend the system.
