  ...
  - type: "steps"
    ...
    steps:
      ...
      - title: "Validate the complete build"
        body: "Complete the checks in the Sphinx build guide and record any discrepancy with its module ID, item ID, and hardware revision."
        href: "/docs/manual/build/"
        ctaLabel: "Open build guide"
  - type: "links"
