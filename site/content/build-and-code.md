  ...
  - type: "steps"
    ...
    steps:
      ...
      - title: "Validate the complete build"
        body: "Use the current interactive tutorial as a bench checklist and record any discrepancy with its module ID, item ID, and hardware revision."
        href: "/docs/beatbox-assembly-tutorial.html"
        ctaLabel: "Open tutorial"
  - type: "links"
    title: "Two assembly-guide versions"
    links:
      - label: "Interactive assembly tutorial"
        href: "/docs/beatbox-assembly-tutorial.html"
        note: "Current module instructions, parts, videos, and persistent bench checklist"
