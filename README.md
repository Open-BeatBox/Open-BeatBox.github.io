# BEATBox (The BEhavioural and AuTonomous Box)
...
- `site/` - Next.js website (static export for GitHub Pages)
- `resources/` - Open-source hardware, firmware, software, docs, and build assets

## Open-source resources
Inside `resources/`, you will find (or can add):
- `hardware/` - CAD, PCB, and mechanical design files
- `firmware/` - device firmware and embedded tooling
- `software/` - data acquisition, control, and analysis software
